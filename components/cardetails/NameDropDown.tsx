      ...
      <div>
        ...
        {isDialogVisible && (
          <div className="">
            ...
            <div className="md:w-1/2 px-3 z-20 shadow-2xl dark:shadow-black shadow-white  bg-primary dark:bg-dark-primary max-h-[400px] overflow-y-auto z-10 absolute md:left-10 left-0 rounded-lg">
              <Dialog />
            </div>
          </div>
        )}
